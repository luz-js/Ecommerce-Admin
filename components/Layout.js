    ...
    if (!session) {
      ...
      <div className='w-screen h-screen flex items-center justify-center bg-blue'>
        <div className='text-center w-96  flex flex-col items-center bg-white rounded-lg p-5'>
          ...
          <button onClick={(e) => signIn('google')} class="px-8 py-2 mt-5 mb-5 border flex gap-2 border-slate-200 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200 hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150">
